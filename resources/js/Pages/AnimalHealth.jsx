...
export default function AnimalHealth({ treatmentTypes, animals, treatments }) {
    // Obter flash messages (caso exista sucesso)
    ...
    return (
        <AuthenticatedLayout
            header={
                <header className="bg-white shadow fixed top-0 inset-x-0 z-50 p-4 flex items-center justify-center border-b border-gray-100">
                    <h2 className="text-xl font-semibold text-gray-300">Saúde Animal</h2>
                </header>
            }
        >
            <Head title="Saúde Animal" />
            <main className="pt-10 pb-8 bg-gray-100 min-h-screen">
                <div className="max-w-md mx-auto px-4">
                    ...
                    <h1 className="text-3xl font-bold mb-6 text-center">Saúde Animal</h1>
                ...
                <div className="max-w-md mx-auto p-4">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            {errors.animal_id && (
                                <div className="text-red-500 text-sm">{errors.animal_id}</div>
                            )}
                        </div>
                        <div className="mb-4">
                            ...
                            <>
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 block w-full border rounded p-2"
                                    />
                                    {errors.vermifugo_type && (
                                        <div className="text-red-500 text-sm">{errors.vermifugo_type}</div>
                                    )}
                                </div>
                                <div className="mb-4">
                                    ...
                                    />
                                    {errors.vermifugo_photo && (
                                        <div className="text-red-500 text-sm">{errors.vermifugo_photo}</div>
                                    )}
                                </div>
                            </>
                        )}
                        ...
                        {selectedType && selectedType.name === 'Vacina' && (
                            <>
                                <div className="mb-4">
                                    ...
                                    />
                                    {errors.vacina_type && (
                                        <div className="text-red-500 text-sm">{errors.vacina_type}</div>
                                    )}
                                </div>
                                <div className="mb-4">
                                    ...
                                    />
                                    {errors.vacina_photo && (
                                        <div className="text-red-500 text-sm">{errors.vacina_photo}</div>
                                    )}
                                </div>
                            </>
                        )}
                            ...
                            <>
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 block w-full border rounded p-2"
                                    />
                                    {errors.suplemento_type && (
                                        <div className="text-red-500 text-sm">{errors.suplemento_type}</div>
                                    )}
                                </div>
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 block w-full"
                                    />
                                    {errors.suplemento_photo && (
                                        <div className="text-red-500 text-sm">{errors.suplemento_photo}</div>
                                    )}
                                </div>
                            </>
                        )}
                        ...
                        {selectedType && selectedType.name === 'Tratamento odontológico' && (
                            <div className="mb-4">
                                ...
                                ></textarea>
                                {errors.procedimento && (
                                    <div className="text-red-500 text-sm">{errors.procedimento}</div>
                                )}
                            </div>
                        )}
                        ...
                        <div className="flex justify-end">
                            <button
                                type="button"
                                onClick={closeModal}
                                className="mr-4 py-2 px-4 bg-gray-500 text-white rounded hover:bg-gray-600 transition-colors"
                            >
                                Cancelar
                            </button>
                            <button
                                type="submit"
                                disabled={processing}
                                className="py-2 px-4 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition-colors"
                            >
                                Salvar
                            </button>
                        </div>
