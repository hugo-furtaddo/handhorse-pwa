...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            {/* Top Navigation (já centralizado internamente se desejar) */}
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink
                            ...
                            active={route().current('animals.*')}
                        >
                            Meus Animais
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            href={route('animals.create')}
                            active={route().current('animals.create')}
                        >
                            Cadastrar Animal
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
            ...
            {/* Renderização dos filhos – sem container extra */}
            {children}
        </div>
    );
}
